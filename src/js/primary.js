const toggleMobileMenu = () => {
  if (
    document.getElementById('nav-options').className
    === 'nav-options--collapsed'
  ) {
...
[...document.getElementsByClassName('menu-anchor')].forEach((element) => element.addEventListener('click', toggleMobileMenu));
